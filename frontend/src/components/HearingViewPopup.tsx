    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
        <DialogDescription className="sr-only">
          Detailed information about the specific hearing and associated notes.
        </DialogDescription>
        <DialogHeader>
        ...
        {!safeHearing || !case_ ? (
          ...
          <Tabs defaultValue="details" className="w-full mt-2">
            ...
            <TabsContent value="notes" className="mt-0 h-[600px] border rounded-lg overflow-hidden bg-card">
              <CaseNotesPanel
                isOpen={true}
                caseId={case_.id}
                hearings={[safeHearing]}
                defaultHearingId={safeHearing.id}
                inline={true}
              />
            </TabsContent>
          </Tabs>
