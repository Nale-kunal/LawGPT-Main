...
export const HearingRecordPopup: React.FC<HearingRecordPopupProps> = ({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // Note: API expects ISO strings for dates, but TypeScript types expect Date objects
      // We send ISO strings and cast to satisfy TypeScript
      const hearingData = {
        caseId: case_.id,
        hearingDate: parsedHearingDate.toISOString(),
        ...
        nextHearingDate: formData.nextHearingDate ? new Date(formData.nextHearingDate).toISOString() : undefined,
