...
const Privacy = () => {
    ...
    const content = (
        <PrivacyContent SectionComponent={Section} />
    );
            ...
            <div className="lp-cta-wrap">
                <div className="lp-cta-card lp-reveal" ref={r(2)}>
                    ...
                    <div style={{ position: 'relative', zIndex: 1 }}>
                        ...
                        <p className="lp-cta-sub">Juriq provides a structured digital system for managing cases, documents, and hearings. Built for Indian advocates, with privacy-first architecture.</p>
